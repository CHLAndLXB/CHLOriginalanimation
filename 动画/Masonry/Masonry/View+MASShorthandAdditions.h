...
@property (nonatomic, strong, readonly) MASViewAttribute *centerXX;
@property (nonatomic, strong, readonly) MASViewAttribute *centerYY;
...
MAS_ATTR_FORWARD(centerXX);
MAS_ATTR_FORWARD(centerYY);
